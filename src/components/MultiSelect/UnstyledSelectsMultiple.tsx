...
type UsersProps = {
    ...
    setOptionsSelected: (option: Array<string>) => void;
};

export default function UnstyledSelectsMultiple(props: UsersProps) {
    const options = props.options;
    function handleSelectChange(e: any) {
        props.setOptionsSelected(e as Array<string>);
    }

    return (
        <CustomMultiSelect onChange={handleSelectChange}>
            {options.map((element, index) => {
                return (
                    <StyledOption value={element.value} key={index}>
                        {element.label}
                    </StyledOption>
                );
            })}
