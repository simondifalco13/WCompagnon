        ...
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                    ...
                    <input
                        placeholder="Entreprise engine..."
                        {...register("name", { required: true })}
                    />
                    {errors.name && <span className="error">This field is required</span>}
                </div>
                <div>
                    <label htmlFor="urlForFrame">Url for frame on the main page</label>
                    <input
                        placeholder="https://example.com"
                        {...register("urlForFrame", { required: true })}
                    />
                    {errors.urlForFrame && <span className="error">This field is required</span>}
                </div>
